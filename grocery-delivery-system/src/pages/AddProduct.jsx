...
//               <input type="text" className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500" />
//             </div>
...
//               <input type="number" className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500" />
//             </div>
  
//             <div>
//               <label className="block text-gray-700 font-medium">Product Description</label>
//               <textarea className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"></textarea>
//             </div>
...
//             <button className="w-full bg-orange-500 text-white p-3 rounded-lg hover:bg-orange-600 transition">Add Product</button>
//           </form>
//         </div>
//       </div>
//     );
