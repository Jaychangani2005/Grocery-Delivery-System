...
import { FiPackage, FiAlertCircle, FiEye } from 'react-icons/fi';
...
const PendingOrders = () => {
  ...
  const fetchPendingOrders = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`http://localhost:5000/api/dashboard/pending-deliveries?seller_id=${user?.seller_id}`);
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100">
          <div className="p-4 sm:p-6 border-b border-gray-100">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <span className="px-3 py-1 text-sm font-medium text-yellow-700 bg-yellow-50 rounded-full">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="flex-1 px-4 py-2 text-sm font-medium text-yellow-600 hover:text-yellow-700 border border-yellow-200 rounded-md hover:bg-yellow-50 transition-colors"
                        >
                          Start Delivery
                        </button>
                      </div>
