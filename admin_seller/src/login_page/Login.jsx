...
// // //         if (response.data.success) {
// // //           login(response.data.role, response.data.name, () => {
// // //             console.log("Login.jsx - After login callback:", { role: response.data.role, name: response.data.name });
// // //             switch (response.data.role) {
// // //               case "seller":
// // //                 navigate("/dashboard", { replace: true }); // Use replace to avoid back navigation issues
// // //                 break;
// // //               case "admin":
...
// // //           error.response?.data?.error || "An error occurred during login"
// // //         );
// // //         console.error("Login.jsx - Error:", error.response?.data);
// // //       }
// // //     }
// // //   };
